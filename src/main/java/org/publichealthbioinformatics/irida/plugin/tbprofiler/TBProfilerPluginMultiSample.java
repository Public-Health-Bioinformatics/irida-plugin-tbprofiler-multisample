 ...
 */
public class TBProfilerPluginMultiSample extends Plugin {
	 ...
	 * for each pipeline).
	 */
	public static final AnalysisType TBPROFILER_MULTISAMPLE = new AnalysisType("TBPROFILER_MULTISAMPLE");

	public TBProfilerPluginMultiSample(PluginWrapper wrapper) {
		super(wrapper);
	}
	...
	public static class PluginInfo implements IridaPlugin {
		 ...
		 * 
		 * <pre>
		 * {@code <analysisType>TBPROFILER_MULTISAMPLE</analysisType>}
		 * </pre>
		 * 
		 ...
		 * 
		 * <pre>
		 * {@code <id>af5c36f6-26db-4ee5-b75f-1bb69c72a6ed</id>}
		 * </pre>
		 * 
		...
		public UUID getDefaultWorkflowUUID() {
			return UUID.fromString("af5c36f6-26db-4ee5-b75f-1bb69c72a6ed");
		}
		...
		public Optional<Color> getBackgroundColor() {
			return Optional.of(Color.decode("#7b42f5"));
		}
		...
		public Optional<AnalysisSampleUpdater> getUpdater(MetadataTemplateService metadataTemplateService,
			...
			return Optional.of(new TBProfilerPluginMultiSampleUpdater(metadataTemplateService, sampleService, iridaWorkflowsService));
		}
	}
}
