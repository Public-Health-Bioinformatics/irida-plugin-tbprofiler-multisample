...
public class TBProfilerPluginMultiSampleUpdaterTest {
    private String WORKFLOW_NAME = "tbprofiler-multisample";
    private String WORKFLOW_VERSION = "0.1.0";

    private TBProfilerPluginMultiSampleUpdater updater;
    ...
    public void setUp() throws IridaWorkflowException {
        ...
        updater = new TBProfilerPluginMultiSampleUpdater(metadataTemplateService, sampleService, iridaWorkflowsService);
